  ...
  return (
    <V2InnerShell>
      <div className="bg-dot-grid relative overflow-hidden -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-8">
            ...
            <ScrollAnimate direction="left" delay={200}>
              <div className="pt-4 flex flex-wrap gap-4">
                <Link
                  ...
                  className="btn-accent shadow-lg shadow-[var(--accent)]/15 hover:shadow-[var(--accent)]/30 hover:scale-[1.02] transition duration-300"
                >
        ...
        <div className="sticky top-[72px] z-30 -mx-4 sm:-mx-6 lg:-mx-8 border-y border-[var(--border)] bg-[var(--bg)]/90 backdrop-blur-md py-4 shadow-sm">
          <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8">
            <div className="flex space-x-6 sm:space-x-8 overflow-x-auto scrollbar-none pr-4">
              <a
                href="#details"
                className="text-xs sm:text-sm font-bold uppercase tracking-wider text-[var(--accent)] hover:text-[var(--accent)] shrink-0 transition"
              >
                Offerings
              </a>
              <a
                href="#overview"
                className="text-xs sm:text-sm font-bold uppercase tracking-wider text-[var(--muted2)] hover:text-[var(--accent)] shrink-0 transition"
              >
                Overview
              </a>
              <a
            ...
            <Link
              href={`/contact?interest=${service.slug}`}
              className="hidden sm:inline-flex items-center gap-1 text-xs font-extrabold uppercase tracking-widest text-[var(--accent)] hover:underline"
            >
        ...
        <div
          id="details"
          className="mt-32 grid gap-8 lg:grid-cols-3 scroll-mt-40"
        >
            ...
            <div className="rounded-3xl border border-[var(--border)] bg-[var(--bg2)] p-8 shadow-lg h-full flex flex-col justify-between hover:border-[var(--teal)]/20 hover:shadow-xl hover:shadow-[var(--teal)]/5 transition duration-300">
              <div>
                ...
                <ul className="space-y-4">
                  {service.outcomes.map((o) => (
                    <li
                      key={o}
                      className="text-sm leading-relaxed text-[var(--muted2)] flex items-start gap-4 p-3 rounded-2xl hover:bg-[var(--surface)] hover:text-[var(--text)] transition duration-200"
                    >
              ...
              {isDev && (
                <div className="mt-8 pt-6 border-t border-[var(--border)]">
                  <Link
                    href="/development"
                    className="link-arrow text-sm font-semibold text-[var(--accent)] hover:underline"
                  >
                    Learn more about Innovexce →
                  </Link>
                </div>
              )}
            </div>
        ...
        <div
          id="overview"
          className="mt-32 grid gap-8 lg:grid-cols-3 border-t border-[var(--border)] pt-24 scroll-mt-40"
        >
          ...
          <ScrollAnimate direction="up" delay={150} className="h-full">
            <div
              id="technologies"
              className="rounded-3xl border border-[var(--border)] bg-[var(--bg2)] p-8 shadow-lg h-full flex flex-col justify-between hover:border-[var(--indigo)]/20 hover:shadow-xl hover:shadow-[var(--indigo)]/5 transition duration-300 scroll-mt-40"
            >
              <div>
                ...
                <p className="text-xs text-[var(--muted)] mb-8 leading-relaxed font-semibold">
                  We design and engineer validation assets using leading
                  frameworks, cloud tools, and compliance utilities standard in
                  this practice.
                </p>
              ...
              <div className="mt-12 pt-6 border-t border-[var(--border)] text-xs text-[var(--muted)] font-semibold">
                Need a custom integration? We build compatibility adapters for
                all enterprise toolchains.
              </div>
            </div>
          </ScrollAnimate>
        </div>
