    ...
    <V2InnerShell>
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-sm leading-6 text-[var(--muted2)] sm:text-base">
          Quality and capability programs tuned to how your customers behave, how your systems integrate,
          and what your business cannot afford to break.
        </p>
      </div>

      <div className="mt-10 grid gap-5 lg:grid-cols-2">
        {industries.map((ind) => {
          const ArtComponent = INDUSTRY_ART[ind.slug];
          return (
            <Link
              key={ind.slug}
            ...
            >
              ...
              {ArtComponent && (
                <div className="h-44 w-full overflow-hidden">
                  <ArtComponent className="h-full w-full rounded-none object-cover transition duration-500 group-hover:scale-[1.02]" />
                </div>
              )}
              ...
              <div className="flex flex-1 flex-col p-6">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="mt-1.5 text-sm leading-6 text-[var(--muted2)]">{ind.summary}</div>
                  </div>
        ...
        <div className="grid gap-6 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-8">
            ...
            <p className="mt-2 text-sm leading-6 text-[var(--muted2)]">
              TestYantra&apos;s quality engineering practice spans healthcare, government, logistics, energy,
              and more. Tell us about your context and we&apos;ll show you how we can help.
            </p>
          </div>
